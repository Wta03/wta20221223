...
<template>
    <div id="di">
        ...
        <el-table ref="multipleTable" tooltip-effect="dark" style="width: 100%" stripe
            ...
            <el-table-column prop="user_time" label="流浪动物发现时间" sortable>
            </el-table-column>
            <el-table-column prop="user_time1" label="发表时间" sortable>
            </el-table-column>
            <el-table-column prop="user_name" label="账号">
            </el-table-column>
            <el-table-column prop="user_type" label="动物类型" sortable>
            </el-table-column>
            <el-table-column prop="user_text" label="描述信息" width="300px">
            </el-table-column>
            <el-table-column prop="user_address" label="发现地点" sortable>
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        showStu1() {
            axios.post('http://localhost:3000/api/Stu/showStu_allll', {}).then((response) => {
